  ...
  return (
    <main className="bg-white dark:bg-white min-h-screen">
      <header className="fixed top-0 left-0 right-0 flex items-center border-b border-b-slate-950 bg-forestGreenMedium dark:bg-forestGreenMedium h-20 z-10">
        ...
        <button
          className="ml-auto mr-5 px-4 py-2 border flex gap-2 bg-gray-800 dark:bg-gray-800 border-slate-700 dark:border-slate-700 rounded-lg text-slate-200 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-300 dark:hover:text-slate-300 hover:shadow transition duration-150"
